...
//
// The Intent Router API emits 21
...
export type IntentDomain =
  "coding" | "ops" | "general_control" | "out_of_scope";
 ...
 * API and UI.
 */
export const EXPERT_ROUTING_ELIGIBLE_LABELS: readonly IntentLabelMeta[] =
  EXPERT_ROUTING_LABELS.filter(
 ...
 */
export const EXPERT_ROUTING_INELIGIBLE_LABELS: readonly IntentLabelMeta[] =
  EXPERT_ROUTING_LABELS.filter(
...
export function getExpertRoutingLabelMeta(
  label: string,
): IntentLabelMeta | undefined {
 ...
 * The API/UI MUST report these values without collapsing Intent Router API and
 * LLM second-pass decisions into a single bucket.
 */
...
export type ExpertRoutingRouteSource =
  (typeof EXPERT_ROUTING_ROUTE_SOURCES)[number];
