export default {
  ...
  validation: {
    ...
    jevChoiceTitle: 'Jev Candidate Expert Choice',
    jevChoiceTooltip: 'Jev chooses directly among candidate expert models, taking the best candidate by choice probability (descending).',
    jevChoiceDesc: 'Candidate IDs are the choice keys; category and description describe suitable tasks. Jev ranks by probability and falls back below the probability threshold.',
    choiceThreshold: 'Probability Threshold',
    choiceThresholdHint: 'When the best candidate\'s choice probability is below this threshold, the request routes to the fallback. Default 0.6.',
    categoryChoiceKeyHint: 'The candidate ID is the Jev choice key; category and description describe suitable tasks.',
  ...
  workerMonitoring: {
    ...
    exportDone: 'Exported {count} runs',
  ...
  agentRunDetail: {
    ...
    liveBadge: 'Live refresh',
    relatedRequests: 'Related model requests',
    relatedRequestsEmpty: 'No related requests (only loopback model calls are tagged; older rows may have been cleaned by log retention)',
    relatedRequestsLoadFailed: 'Failed to load related requests',
    relatedTable: {
      time: 'Time',
      model: 'Model',
      status: 'Status',
    ...
    eventsEmpty: 'No events recorded (running runs append in real time; expired runs have their events cleaned up)',
    eventsTruncated: 'Too many events, showing first {max} only',
    payload: 'Payload',
    lifecycleSteps: {
      queued: 'Queued',
      started: 'Started',
