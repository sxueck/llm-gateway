export default {
  ...
  trafficAnalysis: {
    ...
    peakWindow: 'Peak Forecast',
    noPeak: 'No significant traffic peaks expected in the next 24 hours',
    dataInsufficient: 'Insufficient historical data (< 3 days); predictions are indicative only',
    dataLow: 'Limited historical data (3–6 days); predictions may be less accurate',
    regionLabel: 'Region',
    noRegion: 'Region-aware disabled',
    surgeRatio: 'Above average',
    peakCount: 'Peak requests',
  },
};
