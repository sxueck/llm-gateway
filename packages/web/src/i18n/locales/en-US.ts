export default {
  ...
  trafficAnalysis: {
    ...
    mape: 'MAPE',
    mapeTip: 'Mean absolute percentage error on the held-out set. During low-traffic hours the small base inflates the percentage, so a high value is normal when request volume is low — read it together with the accuracy figure.',
    latency: 'Latency',
