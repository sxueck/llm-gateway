export default {
  ...
  expertRouting: {
    ...
    localClassifierDesc: '主分类由本地 ONNX 模型完成。低置信度、ops 或 out_of_scope 结果将进入下方 LLM 二次分类。',
     ...
     stableLabelPromptHint: '二次分类使用内置且版本化的稳定标签 Prompt。结果会归档为待审核样本，可用于后续训练。',
     trainingRecords: '训练样本',
     trainingRecordsReview: '训练样本审核',
     trainingRecordsHint: 'LLM 二次分类的结果会按输入去重归档。仅已接受样本会导出到训练集。',
     refreshTrainingRecords: '刷新',
     exportAcceptedJsonl: '导出已接受 JSONL',
     noTrainingRecords: '暂无训练样本',
     trainingRecordPendingReview: '待审核',
     trainingRecordAccepted: '已接受',
     trainingRecordRejected: '已拒绝',
     trainingRecordConfidence: '置信度 {confidence} · 出现 {count} 次',
     trainingRecordJudgeReason: 'Judge 理由：{reason}',
     trainingRecordFinalLabel: '最终标签',
     acceptTrainingRecord: '接受',
     rejectTrainingRecord: '拒绝',
     trainingRecordUpdatedAt: '最后更新：{time}',
     trainingRecordLoadFailed: '加载训练样本失败',
     trainingRecordReviewFailed: '审核训练样本失败',
     trainingRecordExportFailed: '导出训练样本失败',
